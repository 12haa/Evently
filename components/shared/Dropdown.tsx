...
const Dropdown = ({ value, onChangeHandler }: DropdownProps) => {
  ...
  useEffect(() => {
    ...
    getCategory().then(() => console.log("Fetched Categories"));
  }, []);
  return (
    <Select onValueChange={onChangeHandler} defaultValue={value}>
      ...
      <SelectContent>
        ...
        <AlertDialog>
          <AlertDialogTrigger className="p-medium-14 flex w-full rounded-sm py-3 pl-8 text-primary-500 hover:bg-primary-50 focous:text-primary-500">
            Add New Category
          </AlertDialogTrigger>
